const messages = {
  en: {
    message: {
      ...
      elections2018: 'Elections 2019',
      exportResults: 'Export results in CSV',
      ballotCast: 'Ballot cast in block {block}',
      logout: 'Logout',
      howItWorks: 'How it works',
      invalidBallot: '{invalidCount} ballot was ignored while counting because it was invalid. Please check the CSV file for more information.',
      invalidBallots: '{invalidCount} ballots were ignored while counting because they were invalid. Please check the CSV file for more information.',
      sorry: 'Sorry',
  ...
  fr: {
    message: {
      ...
      elections2018: 'Élections 2019',
      exportResults: 'Exporter les résultats au format CSV',
      ballotCast: 'Vote enregistré sous {block}',
      logout: 'Déconnexion',
      howItWorks: 'Comment ça marche',
      invalidBallot: '{invalidCount} vote a été ignoré pendant le dépouillement parce qu’il était invalide. Veuillez vérifier le ficher CSV pour plus d’informations.',
      invalidBallots: '{invalidCount} votes ont été ignorés pendant le dépouillement parce qu’ils étaient invalides. Veuillez vérifier le ficher CSV pour plus d’informations.',
      sorry: 'Désolé',
  ...
  de: {
    message: {
      ...
      elections2018: 'Wahlen 2019',
      exportResults: 'Exportieren Sie die Ergebnisse im CSV-Format',
      ballotCast: 'Stimme in block {block} abgegeben',
      logout: 'Ausloggen',
      howItWorks: 'Wie es funktioniert',
      invalidBallot: '{invalidCount} Stimmzettel wurde während der Zählung ignoriert, weil er ungültig war. Weitere Informationen finden Sie in der CSV Datei.',
      invalidBallots: '{invalidCount} Stimmzettel wurden während der Zählung ignoriert, weil sie ungültig waren. Weitere Informationen finden Sie in der CSV Datei.',
  ...
  it: {
    message: {
      ...
      elections2018: 'Elezioni 2019',
      exportResults: 'Esporta i risultati in formato CSV',
      ballotCast: 'Ballot registrato sul blocco {block}',
      logout: 'Disconnessione',
      howItWorks: 'Come funziona',
      invalidBallot: '{invalidCount} voto è stato ignorato durante il conteggio perché non era valido. Si prega di controllare la CSV per ulteriori informazioni.',
      invalidBallots: '{invalidCount} voti sono stati ignorati durante il conteggio perché non erano validi. Si prega di controllare la CSV per ulteriori informazioni.',
      sorry: 'Scusi',
